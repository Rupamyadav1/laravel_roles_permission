...
<label for="" class="text-lg font-medium">Email</label>
                            ...
                            <div class="my-3">
                                <input type="text" value="" name="password" id="password" placeholder="Enter Password" class="border-gray-300 
                                shadow-sm w-1/2 rounded-lg" >
                                @error('name')
                                <p class="text-red-400">{{$message}}</p>
                            ...
                            <div class="my-3">
                                <input type="text" value="" name="confirm_password" id="confirm_password" placeholder="Confirm Password" class="border-gray-300 
                                shadow-sm w-1/2 rounded-lg" >
                                @error('name')
                                <p class="text-red-400">{{$message}}</p>
