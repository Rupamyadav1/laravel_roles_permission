                ...
                <div class="p-6 text-gray-900">
                    <form action="{{ route('user.update',$user->id) }}" method="post">
                        ...
                        <div>
                            ...
                            <div class="my-3">
                                <input type="text" value="{{ old('name',$user->name) }}" name="name" id="name" placeholder="Enter Name" class="border-gray-300 
...
<label for="" class="text-lg font-medium">email</label>
                            <div class="my-3">
                                <input type="text" value="{{ old('email',$user->email) }}" name="email" id="email" placeholder="Enter Email" class="border-gray-300 
                                shadow-sm w-1/2 rounded-lg" >
                                @error('name')
                                <p class="text-red-400">{{$message}}</p>
